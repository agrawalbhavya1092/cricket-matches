! function(t) {
    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        refresh: function() {
            ...
            }, this)), this.createOptionTag(), this.updateSelectAll()
        },
        select: function(e, i) {
            console.log("select.............")
            t.isArray(e) || (e = [e]);
        ...
        clearSelection: function() {
            ...
            this.deselectAll(!1), this.createOptionTag(), this.updateSelectAll()
        },
        ...
        rebuild: function() {
            console.log("rebuild...")
            this.$ul.html(""), this.options.multiple = "multiple" === this.$select.attr("multiple"), this.buildSelectAll(), this.buildDropdownOptions(), this.buildFilter(), this.createOptionTag(), this.updateSelectAll(!0), this.options.disableIfEmpty && t("option", this.$select).length <= 0 ? this.disable() : this.enable(), this.options.dropRight && this.$ul.addClass("pull-right")
        },
        ...
        createOptionTag: function() {
            var e = this.getSelected();
            console.log("createOptionTag////",this.nonSelectedText)
        ...
        setAllSelectedText: function(t) {
            ...
            this.options.allSelectedText = t, this.createOptionTag()
        }
